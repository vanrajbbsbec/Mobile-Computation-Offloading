...
public class CloudSimTags {
	...
	public static final int Battery_INC = BASE + 49;
	
	// Added by Ridhi Sharma
	public static final int Battery_DEC = BASE + 50;
	
	// Added by Ridhi Sharma
	public static final int Wifi_INC = BASE + 51;
	
	// Added by Ridhi Sharma
	public static final int Wifi_DEC = BASE + 52;

	
	/* Reference from Anupinder Singh */
